...
const main = async () => {
    ...
    console.log('impersonneted acct weth bal before swap:', ethers.formatUnits(wethBal, 18))
    ...
    console.log('impersonneted acct weth bal AF:', ethers.formatUnits(wethBalAfter, 18))
