...
const main = async () => {
    ...
    let AmtADesired = ethers.parseUnits('100000', 6);  // USDC amount
    let AmtBDesired = ethers.parseUnits('100000', 18); // DAI amount
    let AmtAMin = ethers.parseUnits('6000', 6);        // Minimum USDC
    let AmtBMin = ethers.parseUnits('5000', 18);       // Minimum DAI
    ...
    let RemoveAmtAMin = ethers.parseUnits('1', 6);  // Lower minimum USDC
    let RemoveAmtBMin = ethers.parseUnits('1', 18); // Lower minimum DAI
