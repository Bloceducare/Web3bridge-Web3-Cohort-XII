...
contract ERC20 {
    ...
    function approve(address _spender, uint256 _value) public returns (bool) {
        ...
        require(_balances[msg.sender] >= _value, "ERC20: approve amount exceeds balance");
    ...
    function allowance(address _owner, address _spender) public view returns (uint256) {
        require(_owner != address(0), "ERC20: allowance query for the zero address owner");
        require(_spender != address(0), "ERC20: allowance query for the zero address spender");
