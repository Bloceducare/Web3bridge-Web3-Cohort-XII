...
export class StakingContract__userInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class StakingContract extends ethereum.SmartContract {
  ...
  userInfo(param0: Address): StakingContract__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new StakingContract__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_userInfo(
    param0: Address,
  ): ethereum.CallResult<StakingContract__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StakingContract__userInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
